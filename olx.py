...
# }
# r = requests.get('https://www.olx.com.eg/en/vehicles/cars-for-sale/?page=1', headers=headers).content
...
with sync_playwright() as p:
    ...
    page.goto("https://www.dubizzle.com.eg/en/vehicles/cars-for-sale/?page=1")
    print(page.content())  # real HTML after JS
